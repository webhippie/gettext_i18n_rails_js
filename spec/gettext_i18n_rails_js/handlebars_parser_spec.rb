...
describe GettextI18nRailsJs::HandlebarsParser do
  ...
  describe 'mixed use tests' do
    it 'parses a full handlebars file' do
      path = File.join(File.dirname(__FILE__), '../fixtures/example.handlebars')
      parser.parse(path, []).should == [["Locale", "/Users/lewang/src/rails/gettext_i18n_rails_js/spec/gettext_i18n_rails_js/../fixtures/example.handlebars:1"],
                                        ["Profile", "/Users/lewang/src/rails/gettext_i18n_rails_js/spec/gettext_i18n_rails_js/../fixtures/example.handlebars:1"],
                                        ["Update\004Updates", "/Users/lewang/src/rails/gettext_i18n_rails_js/spec/gettext_i18n_rails_js/../fixtures/example.handlebars:1"]]

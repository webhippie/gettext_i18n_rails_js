...
translations inside your .js, .jsx, .ts, .tsx, .coffee, .handlebars and
.mustache files, then it will create JSON versions of your .PO files so you can
serve them with the rest of your assets, thus letting you access all your
...
```ruby
gem 'gettext_i18n_rails_js', '~> 3.1.1'
```
...
```ruby
spec.add_dependency 'gettext_i18n_rails_js', '~> 3.1.1'
```
